...
public class databasePopulator implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        this.chatService.save(new Messaggio("Ciao", Timestamp.valueOf("2027-01-23 10:00:00"), user1, user2));
        this.chatService.save(new Messaggio("Ciao!", Timestamp.valueOf("2027-01-23 11:30:00"), user2, user1));
        this.chatService.save(new Messaggio("La via dell'annuncio è corretta?", Timestamp.valueOf("2027-01-23 13:45:00"), user1, user2));
        this.chatService.save(new Messaggio("Si", Timestamp.valueOf("2027-01-23 15:20:00"), user2, user1));
        this.chatService.save(new Messaggio("Perfetto", Timestamp.valueOf("2027-01-23 16:40:00"), user1, user2));
        this.chatService.save(new Messaggio("Ciao", Timestamp.valueOf("2027-01-24 09:15:00"), user3, user4));
        this.chatService.save(new Messaggio("Ciao", Timestamp.valueOf("2027-01-24 11:00:00"), user4, user3));
        this.chatService.save(new Messaggio("Posso venire a qualunque ora?", Timestamp.valueOf("2027-01-24 14:30:00"), user3, user4));
        this.chatService.save(new Messaggio("si sono libero tutta la giornata", Timestamp.valueOf("2027-01-24 16:00:00"), user4, user3));
        this.chatService.save(new Messaggio("Ok va bene",Timestamp.valueOf( "2027-01-25 08:45:00"), user3, user4));
